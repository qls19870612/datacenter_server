CREATE DATABASE  IF NOT EXISTS `dbdiablomuzhilog` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `dbdiablomuzhilog`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: dbdiablomuzhilog
-- ------------------------------------------------------
...
--
-- Dumping data for table `createrole`
--

LOCK TABLES `createrole` WRITE;
/*!40000 ALTER TABLE `createrole` DISABLE KEYS */;
/*!40000 ALTER TABLE `createrole` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `goodsflow`
--

LOCK TABLES `goodsflow` WRITE;
/*!40000 ALTER TABLE `goodsflow` DISABLE KEYS */;
/*!40000 ALTER TABLE `goodsflow` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `moneyflow`
--

LOCK TABLES `moneyflow` WRITE;
...
--
-- Dumping data for table `rolelevelup`
--

LOCK TABLES `rolelevelup` WRITE;
/*!40000 ALTER TABLE `rolelevelup` DISABLE KEYS */;
/*!40000 ALTER TABLE `rolelevelup` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `rolelogin`
--

LOCK TABLES `rolelogin` WRITE;
/*!40000 ALTER TABLE `rolelogin` DISABLE KEYS */;
/*!40000 ALTER TABLE `rolelogin` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `rolelogout`
--

LOCK TABLES `rolelogout` WRITE;
/*!40000 ALTER TABLE `rolelogout` DISABLE KEYS */;
/*!40000 ALTER TABLE `rolelogout` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping events for database 'dbdiablomuzhilog'
--

--
-- Dumping routines for database 'dbdiablomuzhilog'
--
...
-- Dump completed on 2018-12-24 12:09:35
