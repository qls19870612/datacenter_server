	...
	<div id="optionList">
		...
		<div id="setting" data-config="<?php echo $detail_config; ?>">
			...
			<fieldset class="config-collection" id="series">
				...
				<p class="config-itm">
					标题：
					<input class="valElm" id="sname" type="text" value="标题"></p>
				<p class="config-itm">
					单位：
					<input class="valElm" id="svalueSuffix" type="text" value=""></p>
				<p class="config-itm">
					当前完成量：
					<input class="valElm" id="scompleted" type="text" value="">
					<span class="remark">用于关联数据</span>
				</p>
				<p class="config-itm">
					总量：
					<input class="valElm" id="stotal" type="text" value="">
					<span class="remark">用于关联数据</span>
				</p>
...
<div class="row normal" <?php echo $row_normal_sta; ?>>
	...
	<script type="text/javascript" src="d_highchartgauge.js"></script>
</body>
</html>