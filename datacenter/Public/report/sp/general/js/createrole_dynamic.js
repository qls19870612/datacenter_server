...
var _stockCharts = {'addaccountcount':{
	'title':'实时创建账号数据',
	'subtitle':'',
	'case':'#AddAccountCount',
	'sql_id':129,
	'sql_key':'createrole_dynamic',
	'time_axis':'stattime',
	'series' : [{
			'name' : '今天创建账号',
			'dataVal' : 'addaccountcount_a',
			'data':[]
		},{
			'name' : '昨天创建账号',
			'dataVal' : 'addaccountcount_b',
			'data':[]
		},{
			'name' : '周同比创建账号',
			'dataVal' : 'addaccountcount_c',
			'data':[]
		}],
	'intervaler':{}
},'addplayercount':{
	...
	'series' : [{
			'name' : '今天创建角色',
			'dataVal' : 'addplayercount_a',
			'data':[]
		},{
			'name' : '昨天创建角色',
			'dataVal' : 'addplayercount_b',
			'data':[]
		},{
			'name' : '周同比创建角色',
			'dataVal' : 'addplayercount_c',
			'data':[]
		}],
	'intervaler':{}
}}
