...
<body style="margin:0">
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="panel panel-primary">
				<div class="panel-heading">
					<h4 data-ajaxmodsindex="" class="panel-title">
						<i class="glyphicon glyphicon-th-large"></i>
						&nbsp;
						<span class="ctrl-title">参数筛选</span>
					</h4>
				</div>
				<div class="panel-body">
					<div data-area="12" data-loadtype="static" data-sqlcontent="1" data-sqlkey="realtime_recharge_curves" data-sqlid="445" data-config="{#@parameter#@:[{#@title#@:#@基准时间#@,#@name#@:#@time_a#@,#@type#@:#@datepicker#@,#@value#@:#@0#@},{#@title#@:#@对比时间1#@,#@name#@:#@time_b#@,#@type#@:#@datepicker#@,#@value#@:#@-1#@},{#@title#@:#@对比时间2#@,#@name#@:#@time_c#@,#@type#@:#@datepicker#@,#@value#@:#@-7#@}]}" data-mtype="parameter" class="report-mod" style="width:100%; min-height:50px">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="row">
		<div class="col-lg-8">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div id="Recharge"  data-stockid="recharge" class="highchart" style="height: 400px; min-width: 400px"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<script src="js/realtime_recharge_curves.js?t=20140504" type="text/javascript"></script>
