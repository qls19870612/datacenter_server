...
<body style="margin:0">
		...
		<div class="col-lg-12">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div style="width:100%; min-height:50px" class="report-mod" data-mtype="datepicker" data-config="{#@dptimepick#@:0,#@dpmethod#@:1}" data-sqlid="" data-sqlkey="" data-sqlcontent="" data-loadtype="static"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-lg-8">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div id="OnlineInfo" style="height: 400px; min-width: 400px"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-lg-8">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div id="RechargeInfo" style="height: 400px; min-width: 400px"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-lg-8">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div id="CreateroleInfo" style="height: 400px; min-width: 400px"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<script src="js/online_by_day_dynamic.js?t=20140504" type="text/javascript"></script>
