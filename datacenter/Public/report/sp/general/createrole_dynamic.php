...
<body style="margin:0">
	...
	<div class="row">
		<div class="col-lg-8">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div id="AddAccountCount" data-stockid="addaccountcount" class="highchart" style="height: 400px; min-width: 400px"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="row">
		<div class="col-lg-8">
			<div class="panel panel-primary">
				...
				<div class="panel-body">
					<div id="AddPlayerCount" data-stockid="addplayercount" class="highchart" style="height: 400px; min-width: 400px"></div>
				</div>
			</div>
		</div>
	</div>
	...
	<script src="js/createrole_dynamic.js?t=20140504" type="text/javascript"></script>
