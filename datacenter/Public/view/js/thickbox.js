...
function popShow(msg,w,h){
	if (typeof(w)=="undefined") w=250;
	if (typeof(h)=="undefined") h=120;
	$('#MsgPopShow').html('<table border="0" width="' + w +'" height="'+ (h-5) +'"><tr><td align="center">'+msg+'</td></tr></table>');
	tb_show("提示","#TB_inline?height="+h+"&width="+w+"&inlineId=MsgPopShow",false);
	//this.blur();
	//return false;
}

function msgbox(msg){
	$('#MsgPopShow').html('<div id="myMsg" align="center">'+msg+'</div>');
	tb_show("提示","#TB_inline?height=80&width=250&inlineId=MsgPopShow&modal=true",false);
	//this.blur();
	//return false;
}
//************************************
...
$(document).ready(function(){   
	...
	$("body").append('<div id="MsgPopShow" style="display:none"> </div>'); //Edit by Neway @ 2010-06-08 用于弹出信息
});
